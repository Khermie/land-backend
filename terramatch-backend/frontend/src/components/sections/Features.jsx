    ...
    <section className="bg-forest-600 py-16 sm:py-20">
      ...
      <div className="container-page mt-10 grid gap-6 sm:grid-cols-2">
        {FEATURES.map((feature) => (
          <div
            key={feature.title}
            className="rounded-2xl bg-gradient-to-b from-forest-100 to-forest-400 p-8 shadow-card transition-transform duration-300 hover:-translate-y-1 sm:p-10"
          >
            <span
              className="flex h-12 w-12 items-center justify-center rounded-xl bg-forest-700 text-2xl"
              aria-hidden="true"
            >
              {feature.emoji}
            </span>
