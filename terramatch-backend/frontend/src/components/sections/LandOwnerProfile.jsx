  ...
  return (
    <div className="rounded-2xl border border-ink-900/10 bg-white p-6">
      <div className="flex items-start gap-4">
        {/*
          PLACEHOLDER ASSET: owner headshot. Replace with a real photo
          at /src/assets/images/land-owners/kwame-owusu.jpg and swap
          the ImageSkeleton below for an <img>.
        */}
...
function ContactCard({ owner }) {
  ...
  return (
    <div className="rounded-2xl border border-ink-900/10 bg-white p-5">
      ...
      <div className="-mx-2 mt-1 flex items-center gap-3 px-2 py-1.5">
        <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-forest-100 text-forest-700">
      ...
      <Button as="a" href={mailHref} variant="primary" size="md" className="mt-4 w-full">
        Message Now
      </Button>
    </div>
  );
...
export default function LandOwnerProfile({ owner }) {
