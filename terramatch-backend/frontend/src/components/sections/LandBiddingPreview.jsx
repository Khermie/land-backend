...
// so "Place Bid" can link to each listing's real detail page.
const LISTINGS = [
    ...
    <section className="bg-white py-16 sm:py-20">
      <div className="container-page">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.4fr]">
          {/*
            PLACEHOLDER ASSET: physical map photo with a pushpin marking
            a location in Ghana, per the source design. Replace with
            /src/assets/images/map-pin-photo.jpg
          */}
          <ImageSkeleton
            className={cn(
              "aspect-[4/3] w-full rounded-2xl lg:aspect-auto lg:min-h-[420px]",
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {LISTINGS.map((land) => (
              ...
              >
                {/*
                  PLACEHOLDER ASSET: aerial land photo per listing.
                  Replace with /src/assets/images/land/<slug>.jpg
                */}
                <ImageSkeleton className="aspect-[16/9] w-full rounded-none" />
                <div className="p-3.5">
