...
import { SIGNUP_ROLES, SIGNUP_STEPS } from "../../constants/signupConfig";
 ...
 *
 * Form fields are local state only — no backend submission. Validates
 * field presence and email format before proceeding.
 */
export default function SignupForm() {
  ...
  function handleSubmit(e) {
    ...
    setTimeout(() => {
      // Pass the formData and role to the verify page via state
      navigate(`/get-started/verify?role=${roleId}`, {
