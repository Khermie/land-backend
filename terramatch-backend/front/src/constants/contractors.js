import { unsplashUrl, CONTRACTOR_PHOTO_IDS } from "./stockImages";
...
// — only 4 distinct construction/trade photos were sourced, so several
// entries below intentionally repeat one rather than going unillustrated.
export const CONTRACTORS = [
  ...
  // (Electrical, Interior Design, Architecture) have a match.
  {
    ...
    image: unsplashUrl(CONTRACTOR_PHOTO_IDS.electricianPowerPole),
  },
  {
