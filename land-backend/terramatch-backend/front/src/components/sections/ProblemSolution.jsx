import { unsplashUrl, LAND_PHOTO_IDS } from "../../constants/stockImages";
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_0.9fr_1.4fr] lg:gap-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <div className="flex-1 overflow-hidden rounded-xl bg-white shadow-card">
              ...
              {/* Real aerial land photo with pin overlay */}
              <div className="relative aspect-[4/3] overflow-hidden bg-forest-100">
                <img 
                  src={unsplashUrl(LAND_PHOTO_IDS.greenCoveredLand, { w: 800 })} 
                  alt="Land Analysis" 
                  className="h-full w-full object-cover"
                />
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-forest-600/90 text-white shadow-lg backdrop-blur-sm border-2 border-white">
